inherited Frm_Rel_ExtratoItem001: TFrm_Rel_ExtratoItem001
  Caption = 'Frm_Rel_ExtratoItem001'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited Panel3: TPanel
    ...
    object PDJButton3: TPDJButton
      ...
      Caption = 'Extrato do &Item de Serviço por Convêniado'
      ParentFont = False
    ...
    object Panel6: TPanel
      ...
      Align = alTop
      Alignment = taLeftJustify
      Caption = '    Código do Item de Serviço'
      TabOrder = 1
    ...
    object PDJButton1: TPDJButton
      ...
      RepeatInterval = 50
      RepeatStartInterval = 50
      Caption = 'Extrato do &Item de Serviço por Especialidade'
      ParentFont = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
