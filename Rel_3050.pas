...
// Parametros
  ...
  if edt_dtentrada_ain_Ini.Text <> '' then
     begin
     sTemp := 'Dt.Internação de;' +  edt_dtentrada_ain_Ini.Text + ';até;' + edt_dtentrada_ain_Fin.Text;
  ...
  if edt_dtalta_alt_Ini.Text <> '' then
     begin
     sTemp := 'Dt.Alta de;' +  edt_dtalta_alt_Ini.Text + ';até;' + edt_dtalta_alt_Fin.Text;
     OutLine := OutLine + sTemp + ';';
     SetLength(OutLine, Length(OutLine) - 1);
     Stream.Write(OutLine[1], Length(OutLine) * SizeOf(Char));
     Stream.Write(#13#10, Length(#13#10));
...
{  Frm_Imp_4099 := TFrm_Imp_4099.Create(Self);
  ...
  Frm_Bas_Impressao.FCampo1 := 'Dt.Internação de ' +  edt_dtentrada_ain_Ini.Text + '  até  ' + edt_dtentrada_ain_Fin.Text;
  Frm_Bas_Impressao.FCampo2 := 'Dt.Alta            de ' +  edt_dtalta_alt_Ini.Text + '  até  ' + edt_dtalta_alt_Fin.Text;
