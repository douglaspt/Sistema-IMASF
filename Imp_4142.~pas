...
var
  Frm_Imp_4142: TFrm_Imp_4142;

implementation
Uses dtm_principal, dtm_principal2, Rel_EtiquetaBenefi001;
{$R *.DFM}

procedure TFrm_Imp_4142.QuickRep1BeforePrint(
...
procedure TFrm_Imp_4142.FormCreate(Sender: TObject);
begin
QuickRep1.Font.Name := 'Roman12';
end;

procedure TFrm_Imp_4142.QRDBText6Print(sender: TObject;
  var Value: String);
begin
  value := 'Inscrição:    '+value; 
end;

procedure TFrm_Imp_4142.QRDBText2Print(sender: TObject;
  var Value: String);
begin
