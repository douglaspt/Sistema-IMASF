inherited Frm_Cad_SituacEmpr: TFrm_Cad_SituacEmpr
  Caption = 'Frm_Cad_SituacEmpr'
  ClientWidth = 798
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Panel3: TPanel
    ...
    object Panel1: TPanel
      ...
      TabOrder = 2
      object edt_descricao_sie: TBEdit
        Tag = -1
        Left = 120
        Top = 5
        Width = 321
    ...
    object Panel4: TPanel
      ...
      TabOrder = 0
      object edt_cod_situacempr: TEditButton
        Tag = -2
        Left = 120
        Top = 5
        Width = 93
        ...
        Font.Style = []
        OnButtonClick = edt_cod_situacemprButtonClick
        Glyph.Data = {
