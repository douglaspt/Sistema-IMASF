...
begin
  inherited;
  value := 'ENDEREÇO '+fdt_principal2.spc_cons_adm_beneficiario002.FieldByName('endereco_ben').AsString + ', ' +
...
begin
  inherited;
  value := 'vem respeitosamente, de acordo com a Legislação em vigor, expor e requerer a segunda';
end;

procedure TFrm_Imp_4097.QRDBText2Print(sender: TObject; var Value: String);
begin
  inherited;
  value := 'via da carteira de identificação ';
end;
