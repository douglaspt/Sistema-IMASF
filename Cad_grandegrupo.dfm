inherited Frm_Cad_grandegrupo: TFrm_Cad_grandegrupo
  Caption = 'Frm_Cad_grandegrupo'
  ClientWidth = 798
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Panel3: TPanel
    ...
    object Panel1: TPanel
      ...
      TabOrder = 7
      object edt_matmedgdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 3
        Width = 33
    ...
    object Panel4: TPanel
      ...
      Caption = '    Código '
      TabOrder = 0
      object edt_cod_grandegrupo: TEditButton
        Tag = -2
        Left = 120
        Top = 5
        Width = 93
        ...
        Font.Style = []
        OnButtonClick = edt_cod_grandegrupoButtonClick
        Glyph.Data = {
    ...
    object Panel7: TPanel
      ...
      Caption = '    Nome Completo'
      TabOrder = 6
      object edt_medicagdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 3
        Width = 33
    ...
    object Panel8: TPanel
      ...
      Caption = '    Nome Completo'
      TabOrder = 5
      object edt_tabespgdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 3
        Width = 33
    ...
    object Panel9: TPanel
      ...
      Caption = '    Nome Completo'
      TabOrder = 4
      object edt_tititmgdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 5
        Width = 310
    ...
    object Panel10: TPanel
      ...
      Caption = '    Nome Completo'
      TabOrder = 3
      object edt_titsubgdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 5
        Width = 310
    ...
    object Panel11: TPanel
      ...
      Caption = '    Nome Completo'
      TabOrder = 2
      object edt_titgrpgdegrp: TBEdit
        Tag = -1
        Left = 120
        Top = 5
        Width = 310
