...
type
  TFrm_Imp_Adm_Etiqueta006 = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
...
var
  Frm_Imp_Adm_Etiqueta006: TFrm_Imp_Adm_Etiqueta006;

implementation
Uses dtm_principal, dtm_principal2;
{$R *.DFM}

procedure TFrm_Imp_Adm_Etiqueta006.QuickRep1BeforePrint(
...
procedure TFrm_Imp_Adm_Etiqueta006.FormCreate(Sender: TObject);
begin
QuickRep1.Font.Name := 'Roman12';
end;

procedure TFrm_Imp_Adm_Etiqueta006.QRDBText6Print(sender: TObject;
  var Value: String);
begin
  value := 'Inscrição:    '+value; 
end;

procedure TFrm_Imp_Adm_Etiqueta006.QRDBText2Print(sender: TObject;
  var Value: String);
begin
