      ...
      object PageControl: TPageControl
        ...
        object tbs_principal: TTabSheet
          ...
          object Label11: TLabel
            ...
            Width = 103
            Height = 13
            Caption = 'Status do Beneficiário'
          end
          ...
          object PDJButton3: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Reemissão de Autorização para Perícia'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object PDJButton5: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Aprovação Administrativa'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object PDJButton6: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = 'Aprovação da Perícia Médica'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object PDJButton7: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Aprovação de Inscrição (1º Contribuição)'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object PDJButton1: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Reemissão de Formulario de Adesão'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
        ...
        object tbs_aprovacao: TTabSheet
          ...
          object Label4: TLabel
            ...
            Width = 346
            Height = 16
            Caption = 'Confirmação para Aprovação da Inscrição de Beneficiário'
          end
          object chb_aprov2: TCheckBox
            ...
            Width = 473
            Height = 17
            Caption = 'Confirmo que o Beneficiário acima possui a devida documentação'
            TabOrder = 0
          ...
          object chb_aprov1: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que o Beneficiário acima preenche todos requisitos para' +
              ' inscrição'
            TabOrder = 1
            OnClick = chb_aprov1Click
          end
          object btn_imprimirauto: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Imprimir Autorização para Perícia'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object btn_aprovarpericia: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Aprovar para Perícia Médica'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
          ...
          object btn_imprimiradesao: TPDJButton
            ...
            RepeatInterval = 50
            RepeatStartInterval = 50
            Caption = '&Imprimir Formulario de Adesão'
            ParentFont = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
        ...
        object tbs_pericia: TTabSheet
          ...
          object Label5: TLabel
            ...
            Width = 334
            Height = 16
            Caption = 'Confirmação para Aprovação da Perícia de Beneficiário'
          end
          ...
          object chb_pericia3: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que todas as doenças pré existentes encontram-se cadast' +
              'radas'
            TabOrder = 1
          ...
          object chb_pericia2: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que o beneficiário não possui doenças pre existentes - ' +
              'Carência Nível IV'
            TabOrder = 2
          ...
          object PageControl1: TPageControl
            ...
            object TabSheet2: TTabSheet
              ...
              object Label17: TLabel
                ...
                Width = 136
                Height = 13
                Caption = 'Data da Perícia Médica'
              end
        ...
        object tbs_contribuicao: TTabSheet
          ...
          object Label6: TLabel
            ...
            Width = 313
            Height = 16
            Caption = 'Confirmação para Primeira contribuição do Assistido'
          end
          object GroupBox1: TGroupBox
            ...
            Width = 417
            Height = 177
            Caption = 'Registrar 1º Contribuição'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object chb_contrib2: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que ao registrar o pagamento o Assistido estará desbloq' +
        ...
        object tbs_reprovacao: TTabSheet
          ...
          object Label7: TLabel
            ...
            Width = 355
            Height = 16
            Caption = 'Confirmação para Reprovação da Inscrição de Beneficiário'
          end
          ...
          object chb_recusar: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que o Beneficiário acima será permanentemente excluído ' +
              'do cadastro e suas informações serão perdidas'
            TabOrder = 1
        ...
        object tbs_aprovacaoben: TTabSheet
          ...
          object Label12: TLabel
            ...
            Width = 253
            Height = 16
            Caption = 'Confirmação para Inclusão do Beneficiário'
          end
          ...
          object chb_confirmaInscricao: TCheckBox
            ...
            Height = 17
            Caption = 
              'Confirmo que o Beneficiário acima estará desbloqueado para uso d' +
              'o Plano'
            TabOrder = 0
