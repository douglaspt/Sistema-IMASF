...
type
  TFrm_Imp_Adm_Etiqueta007 = class(TForm)
    QuickRep: TQuickRep;
    QRBand1: TQRBand;
    QRShape1: TQRShape;
    QRLabel1: TQRLabel;
...
var
  Frm_Imp_Adm_Etiqueta007: TFrm_Imp_Adm_Etiqueta007;

implementation
Uses dtm_principal, dtm_principal2;
{$R *.DFM}

procedure TFrm_Imp_Adm_Etiqueta007.QuickRepBeforePrint(
...
procedure TFrm_Imp_Adm_Etiqueta007.FormCreate(Sender: TObject);
begin
QuickRep.Font.Name := 'Roman12';
end;

procedure TFrm_Imp_Adm_Etiqueta007.QRDBText6Print(sender: TObject;
  var Value: String);
begin
  value := 'Inscrição:    '+value;
end;

procedure TFrm_Imp_Adm_Etiqueta007.QRDBText2Print(sender: TObject;
  var Value: String);
begin
