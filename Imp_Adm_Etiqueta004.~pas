...
type
  TFrm_Imp_Adm_Etiqueta004 = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
...
var
  Frm_Imp_Adm_Etiqueta004: TFrm_Imp_Adm_Etiqueta004;

implementation
Uses dtm_principal, dtm_principal2;
{$R *.DFM}

procedure TFrm_Imp_Adm_Etiqueta004.QuickRep1BeforePrint(
...
procedure TFrm_Imp_Adm_Etiqueta004.FormCreate(Sender: TObject);
begin
QuickRep1.Font.Name := 'Roman12';
end;

procedure TFrm_Imp_Adm_Etiqueta004.QRDBText6Print(sender: TObject;
  var Value: String);
begin
  value := 'Inscrição:    '+value; 
end;

procedure TFrm_Imp_Adm_Etiqueta004.QRDBText2Print(sender: TObject;
  var Value: String);
begin
