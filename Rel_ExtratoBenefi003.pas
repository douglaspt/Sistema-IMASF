...
begin
  ...
  Frm_Bas_Impressao.FMesReferencia := 'Periodo de '+edt_dtinicial.Text+'  até  '+edt_dtfinal.Text;
  if (edt_valor_ini.Text <> '') and (edt_valor_fin.Text <> '') then
    Frm_Bas_Impressao.FCampo1 := 'Valor de '+edt_valor_ini.Text+'  até  '+edt_valor_fin.Text;
  ...
  if (edt_idade_ini.Text <> '') and (edt_idade_fin.Text <> '') then
    Frm_Bas_Impressao.FCampo4 := 'Idade de '+edt_idade_ini.Text+'  até  '+edt_idade_fin.Text;
