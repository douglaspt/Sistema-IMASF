...
type
  TFrm_Imp_4137 = class(TFrm_Imp_Basico)
...
var
  Frm_Imp_4137: TFrm_Imp_4137;

implementation
uses dtm_principal6, Fun_Data;
{$R *.DFM}

procedure TFrm_Imp_4137.QRSysData2Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TFrm_Imp_4137.QRDBText2Print(sender: TObject; var Value: String);
begin
  inherited;
