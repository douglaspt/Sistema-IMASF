inherited Frm_Cad_textoRequerimento: TFrm_Cad_textoRequerimento
  Caption = 'Frm_Cad_textoRequerimento'
  ClientWidth = 798
  Scaled = False
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Panel3: TPanel
    ...
    object Panel4: TPanel
      ...
      Caption = '    Código '
      TabOrder = 0
      object edt_cod_textoRequerimento: TEditButton
        Tag = -2
        Left = 120
        Top = 5
        Width = 93
        ...
        Font.Style = []
        OnButtonClick = edt_cod_textoRequerimentoButtonClick
        Glyph.Data = {
